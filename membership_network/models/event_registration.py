...
class EventRegistration(models.Model):
    ...
    session_1_table_name = fields.Char(string="Session 1 Table Name", related="session_1_table_id.name")
    session_2_table_id = fields.Many2one('event.booking.table', string="Session 2")
    session_2_table_name = fields.Char(string="Session 2 Table Name", related="session_2_table_id.name")
    session_3_table_id = fields.Many2one('event.booking.table', string="Session 3")
    session_3_table_name = fields.Char(string="Session 3 Table Name", related="session_3_table_id.name")
